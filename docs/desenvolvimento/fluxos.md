...
Os fluxos de registro, login e perfil já existem, mas ainda precisam de validação final entre frontend e backend.

Catálogo, endereço, produtos administrativos, pedido, pagamento e baixa de estoque ainda precisam de evidência completa para serem considerados prontos para operação.
